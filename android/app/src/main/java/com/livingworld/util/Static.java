...
public class Static {
    ...
    public final static String IP = "103.84.192.244"+PORT;
    public final static String APPS = "/lw/api/v1/";
    public final static String BASE_URL = "https://mobile.livingworld.co.id/lw/api/v1/";
    //public final static String BASE_URL = "http://"+IP+APPS;
    public final static String IMAGES_URL = "https://mobile.livingworld.co.id/lw/api/v1/files/";
    //public final static String IMAGES_URL = "http://"+IP+APPS+"files";
    public final static String LW_URL = "http://149.129.216.149/loyalty/";
    ...
    public final static String MASTER_GENDER = "gender";
    public final static String MASTER_NATIONALITY = "nationality";
    public final static String MASTER_CITY = "city";
}
