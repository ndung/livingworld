    ...
    <s:layout-component name="contents">
        <div class="panel">
            <div class="panel-body">
                <s:form class="form-horizontal" beanclass="id.co.icg.lw.web.redeem.EditRewardActionBean">
                    <s:hidden name="reward"/>
                    <div class="p-x-1 col-md-5">
                        ...
                        <s:submit name="update" class="btn btn-md btn-primary m-t-1">Update Reward</s:submit>
