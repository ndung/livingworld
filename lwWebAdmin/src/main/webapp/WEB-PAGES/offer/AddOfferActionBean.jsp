    ...
    <s:layout-component name="contents">
        <div class="panel">
            <div class="panel-body">
                <s:form class="form-horizontal" beanclass="id.co.icg.ie.web.offer.AddOfferActionBean">
                    <div class="p-x-1 col-md-5">
                        ...
                        <s:submit name="add" class="btn btn-md btn-primary m-t-1 confirm">Add Offer</s:submit>
